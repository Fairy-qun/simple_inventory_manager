...
<body>
  <div class="main">
    ...
    <!-- 页面 -->
    <div class="page">
      <div class="title">修改出库单</div>
      <!-- 表单 -->
      <form name="form" method="post" id="form">
        <div class="form_item">
          <label for="inbound_order_code">出库单号：</label>
          <input type="text" id="inbound_order_code" name="inbound_order_code" required placeholder="出库单号">
        </div>
        <div class="form_item">
        ...
        <div class="form_item">
          <label for="inbound_time">出库时间：</label>
          <input type="date" id="inbound_time" name="inbound_time" required placeholder="出库时间">
        </div>
        <div class="form_item">
...
<script>
  ...
  const cancleHandler = () => {
    ...
    location.href = './outbound_order.php'
  }
  ...
  const confirmHandler = () => {
    ...
    $.ajax({
      ...
      type: 'POST',
      url: "../action/updateOutboundOrderAction.php",
      data: {
        data: dataArr,
      ...
      success: function(message) {
        ...
        if (message == 'noValue') {
          ...
          alert("修改数据成功")
          location.href = '../pages/outbound_order.php';
        } else {
          alert("修改数据失败")
        }
      }
