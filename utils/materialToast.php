...
<head>
  ...
  <link rel="stylesheet" href="../css/materialToast.css">
</head>
  ...
  <div class="toast">
    <div class="dialog">
      ...
      <form method="post" name="form">
        ...
        <div class="btns">
          <!-- <input type="submit" value="提交" class="ipt_btn"> -->
...
<script>
  ...
  const submitHandler = () => {
    ...
    if (title_txt === '添加数据') {
      console.log("添加");
      document.form.action = '../action/addMaterialAction.php'
      document.form.submit()
    } else if (title_txt === '修改数据') {
      console.log("修改数据");
      const id = document.querySelector('#id').value
      document.form.action = '../action/updateMaterialAction.php?id=' + id
      document.form.submit()
    }
  }
</script>
